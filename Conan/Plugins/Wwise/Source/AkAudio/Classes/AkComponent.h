...
public:
	...
	*/
	...
	void RefreshOcclusionObstruction() { ObstructionService.Refresh(Listeners, GetPosition(), GetOwner(), GetSpatialAudioRoom(), OcclusionCollisionChannel, OcclusionRefreshInterval); }
...
{
	extern FName NAME_SoundOcclusion;
}